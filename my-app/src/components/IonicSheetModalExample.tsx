...
function IonicSheetModalExample() {
  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        <IonButton id="open-sheetmodal" expand="block">
          Open Sheet Modal
        </IonButton>
        <IonModal ref={modal} trigger="open-sheetmodal" initialBreakpoint={0.25} breakpoints={[0, 0.25, 0.5, 0.75]}>
          <IonContent className="ion-padding">
...
export default IonicSheetModalExample;